function CBetPanel(){
    ...
    this._init = function(){
        ...
        if (DISABLE_SOUND_MOBILE === false || s_bMobile === false) {
            ...
            _pStartPosAudio = {x: _pStartPosExit.x , y: oSpriteExit.height + oSprite.height/2 + 20};
        ...
        this.setMoney (Number($("#money").val()))
    ...
    this.clearBet = function(){
        ...
        s_iCurMoney = parseFloat(Number(s_iCurMoney).toFixed(2));
        s_iGameCash -= _iTotBet;
        s_iGameCash = parseFloat(Number(s_iGameCash).toFixed());
    ...
    this.onStartExit = function(){
        if(_iTotBet < MIN_BET){
            ...
            if (_walletId !== undefined) {
                //const url = 'https://backend.hederadogs.app/api/control/transfertoloyalty';
    ...
    this.onExit = function(){
        var _walletId = $("#walletId").val();
        //const url = 'https://backend.hederadogs.app/api/control/exitBtn';
