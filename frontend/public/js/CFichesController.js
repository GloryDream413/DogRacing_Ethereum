function CFichesController(iScale,oParentContainer){
	...
	_pFicheStartPos=new CVector2();
        ...
        _oBetAmountText.text = "Place Wager";
        _oBetAmountText.y = _oBetAmountText.y + 16;
        _oBetAmountText.color = "blue";
...
*/
                 var oSpriteChip = new CFicheBut(aFiches[i].index,iXOffset,iYOffset,iScale,_oFichesAttach);
                 oSpriteChip.disable();
