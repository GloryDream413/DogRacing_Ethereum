function CInterface() {
    ...
    this._init = function () {
        var oSpriteForward = s_oSpriteLibrary.getSprite('but_forward');

        _pStartPosForward = {x: oSpriteForward.width/2 + 10, y: (oSpriteForward.height / 2) + 10};
        _oButForward = new CGfxButton(_pStartPosForward.x, _pStartPosForward.y, oSpriteForward);
        _oButForward.addEventListener(ON_MOUSE_UP, this._onForward, this);
    ...
    this.refreshButtonPos = function (iNewX, iNewY) {
        ...
        _oButForward.setPosition(_pStartPosForward.x - iNewX, _pStartPosForward.y + iNewY);
