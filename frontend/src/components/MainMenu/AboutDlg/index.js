...
function AboutDlg({
    ...
    const [value, setValue] = useState(totalHbarAmount>100?100:totalHbarAmount);
        ...
        <div
            ...
            <div style={{
                ...
                <Box sx={{ width: 270, marginTop: '10px'}}>
                    <div className=''>
                        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Amount To Deposit:</label>
                        <input 
                            type="number"
